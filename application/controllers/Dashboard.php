...
class Dashboard extends CI_Controller {
    ...
    public function index() {
        $this->result['count_user_category'] = $this->db->count_all('tbl_student_category');
        $this->result['count_users'] = $this->db->count_all('tbl_users');
        $this->result['count_question'] = $this->db->count_all('tbl_questioner_question');
        $this->result['count_questioner_category'] = $this->db->count_all('tbl_questioner_category');
        $this->result['count_questioner'] = $this->db->count_all('tbl_questioner_list');
        $this->result['count_regd_questioner'] = $this->db->count_all('tbl_questioner_list');
        $this->result['count_math_question'] = $this->db->count_all('tbl_maths_question');
