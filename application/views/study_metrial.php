                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='category_list' 
                                                   data-toggle="table" data-url="<?= base_url() . 'Table/study_metarial' ?>"
                                                ...
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="video_title" data-sortable="true">Title</th>
                                                        <th class="table-color" scope="col" data-field="video_link" data-sortable="true">Document</th>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Add Study Metrial</h5>
                            ...
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                    
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="video_title" class="form-control" placeholder="Title" / required>
                                    </div> 
                                    <!--<div class="col-md-6">-->
                                    <!--    <label class="control-label">Document<span style="color:red;">( Up to 10 MB )</span></label>-->
                                    <!--    <input id="file" name="video_link" type="file" accept = "application/pdf,.csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" class="form-control" required>-->
                                    <!--</div>-->
                                    <div class="col-md-6">
                                        <label class="control-label">Only Pdf <span style="color:red;">( Up to 10 MB )</span></label>
                                        <input id="" name="video_link" type="file" accept = "application/pdf,.csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" class="form-control">
                                    </div>
                                </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="editDataModal">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Study Metrial</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                    
                                    <div class="col-md-6">
                                        <label class="control-label">Select category</label>
                                        <select name="category" class="form-control select-category" id="edit-category-name" required>
                                            <option value = "">Select Category</option>
                                            <?php foreach($category as $res){?>
                                            <option value = "<?= $res->id ?>"><?= $res->name ?></option>
                                            <?php }?>
                                ...
                                <div class="form-group row">                                                    
                                    <div class="col-md-6">
                                        <label class="control-label">Title</label>
                                        <input type="text" name="video_title" id="edit_title" class="form-control" placeholder="Title"/ required>
                                    </div> 
                                    <div class="col-md-6">
                                        <label class="control-label">Only Pdf <span style="color:red;">( Up to 10 MB )</span></label>
                                        <input id="" name="video_link" type="file" accept = "application/pdf,.csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" class="form-control">
                                        <div id="uploaded_file" class="mt-1"></div>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).on('click', '.edit-cat-data', function () {
                ...
                $(".edit_subject").append("<option value="+ subject_id +">"+subject_name+"</option>");
                 ...
                 $("#uploaded_file").text("");
                 $("#uploaded_file").append('<a href='+link+' target="_blank"><span class="badge badge-warning">Document</span></a>');
