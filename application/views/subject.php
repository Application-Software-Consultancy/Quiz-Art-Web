...
<html lang="en">
    ...
    <body>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='category_list' 
                                                   data-toggle="table" data-url="<?= base_url() . 'Table/all_subject' ?>"
                                                ...
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="sno" data-sortable="true">S. No.</th>
                                                        <th class="table-color" scope="col" data-field="name" data-sortable="true">Subject Name</th>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="sub_category" data-sortable="true">Subcategory</th>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                    
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label">Subject Name</label>
                                        <input name="name" type="text" class="form-control" required placeholder="Enter Subject Name">
                                    </div> 
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <label class="custom-switch d-block pl-0">
                                            <input type="checkbox" id="is_add_status_switch" data-plugin="switchery">
                                        </label>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                    
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label">Subject Name</label>
                                        <input id="edit_category" name="name" type="text" class="form-control" required placeholder="Enter Subject Name">
                                    </div> 
                                </div>
        ...
        <script type="text/javascript">
            ...
            var changeIsPremiumSwitch = document.querySelector('#is_add_status_switch');
            ...
            $(document).on('click', '.edit-cat-data', function () {
                 ...
                 $(".edit_class").append("<option value="+ class_id +">"+classname+"</option>");
            ...
            $(document).on('click', '.view-cat-data', function () {
                 ...
                 $('#view-subject').val($(this).data('name'));
                 $('#view-category-name').val($(this).data('cat_name'));
                 $('#view-class').val($(this).data('classname'));
