                                    ...
                                    <div class="card">
                                        <div class="card-body mt-4">
                                            <form method="post" class="needs-validation" novalidate=""  enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <label class="control-label"><span style="color:red;">App Validity</span></label>
                                                        <input id="app_validity" type="date" name="app_validity" class="form-control" value="<?= isset($app_validity) ? $app_validity['message'] : " " ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-12">
