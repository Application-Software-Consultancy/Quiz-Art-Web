                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='category_list' 
                                                ...
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="course_name" data-sortable="true">Course Name</th>
                                                        <th class="table-color" scope="col" data-field="student_name" data-sortable="true">Student Name</th>
                                                        <th class="table-color" scope="col" data-field="email" data-sortable="true">Student Email</th>
                                                        <th class="table-color" scope="col" data-field="amount" data-sortable="false">Amount Paid</th>
                                                        <th class="table-color" scope="col" data-field="cupon" data-sortable="false">Coupon (If Any)</th>
                                                        <th class="table-color" scope="col" data-field="enroll" data-sortable="false">Enroll Date</th>
                                                        <th class="table-color" scope="col" data-field="validity" data-sortable="false">Validity Date</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
