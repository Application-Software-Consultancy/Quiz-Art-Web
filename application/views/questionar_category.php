    ...
    <body>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='category_list' 
                                                   data-toggle="table" data-url="<?= base_url() . 'Table/questionar_category' ?>"
                                                ...
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="name" data-sortable="true">Contributor Category Name</th>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="validity" data-sortable="true">Validity</th>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Questioner Category</h5>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                    
                                    <div class="col-md-6">
                                        <label class="control-label">Contributor Category Name</label>
                                        <input id="view-category-name" type="text" class="form-control" placeholder="Enter Contributor Category Name" readonly>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">    
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="view-validity" type="text" class="form-control" placeholder="Enter Validity" readonly>
                                    </div>
                                </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="addDataModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Add Questioner Category</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                 
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label">Validity</label>
                                        <input id="add-category-name" name="validity" type="text" class="form-control" required placeholder="Enter validity" required>
                                    </div>
                                </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="editDataModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Questioner Category</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                 
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label">Validity</label>
                                        <input id="edit-validity" name="validity" type="text" class="form-control" required placeholder="Enter validity" required>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).on('click', '.view-cat-data', function () {
                 ...
                 $('#view-validity').val($(this).data('validity'));
