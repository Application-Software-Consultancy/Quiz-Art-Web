                                        ...
                                        <table aria-describedby="mydesc" class='table-striped' id='category_list' data-toggle="table" data-url="<?= base_url() . 'Table/student_category' ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200, All]" data-search="true" data-toolbar="#toolbar" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-mobile-responsive="true" data-sort-name="id" data-sort-order="desc" data-pagination-successively-size="3" data-maintain-selected="true" data-show-export="true" data-export-types='["csv","excel","pdf"]' data-export-options='{ "fileName": "category-list-<?= date('d-m-y') ?>" }' data-query-params="queryParams">
                                            <thead class="table-head">
                                                <tr>
                                                    ...
                                                    <th class="table-color" scope="col" data-field="name" data-sortable="true">Category Name</th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">View Student category</h5>
                        ...
                        <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="view-validity" name="name" type="text" class="form-control" placeholder="Enter Validity" readonly>
                                </div>
                            </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="addDataModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Add Student Category</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="card-body">
                        <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label class="control-label">Validity</label>
                                    <input type="number" id="edit-validity" name="validity" class="form-control" value="">
                                </div>
                            </div>
