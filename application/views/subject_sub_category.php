    ...
    <body>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='category_list' 
                                                   data-toggle="table" data-url="<?= base_url() . 'Table/subject_subcategory' ?>"
                                                ...
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="yearly_fees" data-sortable="true">Yearly Fees</th>
                                                        <th class="table-color" scope="col" data-field="half_fees" data-sortable="true">Half Fees</th>
                                                        <th class="table-color" scope="col" data-field="annual_fees" data-sortable="true">Quarterly Fees</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">View Sub Category</h5>
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">    
                                    <div class="col-md-6">
                                        <label class="control-label">Yearly Fees</label>
                                        <input id="view-yearly" type="text" class="form-control" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="control-label">Half Fees</label>
                                        <input id="view-half" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label class="control-label">Quarterly Fees</label>
                                        <input id="view-quarterly" type="text" class="form-control" readonly>
                                    </div>
                                </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="addDataModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Add Subject Sub Category</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                            ...
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                 
                                    <div class="col-md-6 col-sm-6">
                                        <label class="control-label">Yearly Fees</label>
                                        <input id="add-category-name" name="yearly_fees" type="text" class="form-control" required placeholder="Enter Yearly Fees" required>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <label class="control-label">Half Yearly Fees</label>
                                        <input id="add-category-name" name="half_fees" type="text" class="form-control" required placeholder="Enter Half Yearly Fees" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">                                                 
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label">Quarterly Fees</label>
                                        <input id="add-category-name" name="annual_fees" type="text" class="form-control" required placeholder="Enter Annual Fees" required>
                                    </div>
                                </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="editDataModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Subject Sub Category</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                               ...
                               <div class="form-group row">                                                 
                                    <div class="col-md-6 col-sm-6">
                                        <label class="control-label">Yearly Fees</label>
                                        <input id="edit-yearly-fees" name="yearly_fees" type="text" class="form-control" required placeholder="Enter Yearly Fees" required>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <label class="control-label">Half Yearly Fees</label>
                                        <input id="edit-half-fees" name="half_fees" type="text" class="form-control" required placeholder="Enter Half Yearly Fees" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">                                                 
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label">Quarterly Fees</label>
                                        <input id="edit-annual-fees" name="annual_fees" type="text" class="form-control" required placeholder="Enter Annual Fees" required>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            $(document).on('click', '.edit-cat-data', function () {
                 ...
                 $('#edit-yearly-fees').val($(this).data('yearly_fees'));
                 $('#edit-half-fees').val($(this).data('half_fees'));
                 $('#edit-annual-fees').val($(this).data('annual_fees'));
            ...
            $(document).on('click', '.view-cat-data', function () {
                $('#view-sub-category-name').val($(this).data('sub_cat_name'));
                 ...
                 $('#view-yearly').val($(this).data('yearly_fees'));
                 $('#view-half').val($(this).data('half_fees'));
                 $('#view-quarterly').val($(this).data('annual_fees'));
