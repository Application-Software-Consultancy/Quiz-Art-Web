                                            ...
                                            <form id="frmQuestion" method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">                                               
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        ...
                                                        <div class="select_chapter">
                                                            <select id="category" name="category" class="form-control edit_chapter" required>
                                                                <option value="">Select Main Category</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">                                                    
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <textarea class="form-control" id="e" name="note" required><?= ($question_id !=  '') ? ((!empty($data)) ? $data[0]->optiond : '') : '' ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
