...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Login | Quizart</title>

        <?php base_url() . include 'include.php'; ?>
    </head>

    <body >
        <div class="login" style="background-image: url(<?= base_url() . LOGO_IMG_PATH .'quiz_back.png'; ?>); background-position: center;">
            <div class="overlay">
                <div id="app">
                                    ...
                                    <div class="card login_card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php
                                                ...
                                                <?php }else{?>
                                                    <div class="text-muted"> Copyright &copy; QUIZART <?= date('Y') ?></div>
                                                <?php }
                                            ?>
                                            </div>
                                        </div>
