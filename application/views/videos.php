                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='category_list' 
                                                   data-toggle="table" data-url="<?= base_url() . 'Table/videos' ?>"
                                                ...
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="video_title" data-sortable="true">Video Title</th>
                                                        <th class="table-color" scope="col" data-field="video_link" data-sortable="true">Video Link</th>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                    
                                    ...
                                    <div class="col-md-6">
                                        <label class="control-label">Video <span style="color:red;">Only MP4 video can be uploaded ( Upto 10 mb to 25 mb )</span></label>
                                        <input id="file" name="video_link" type="file" accept="video/*" class="form-control" required>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">                                                    
                                    <div class="col-md-6">
                                        <label class="control-label">Video Title</label>
                                        <input type="text" name="video_title" id="edit_title" class="form-control" placeholder="Video Title"/ required>
                                    </div> 
                                    <div class="col-md-6">
                                        <label class="control-label">Video <span style="color:red;">Only MP4 video can be uploaded ( Upto 10 mb to 25 mb )</span></label>
                                        <input id="" name="video_link" type="file" accept="video/*" class="form-control">
                                    </div>
                                </div>
