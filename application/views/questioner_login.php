...
<html lang="en">
    ...
    <head>
        ...
        <title>Questioner Login | Quizaert</title>
                                ...
                                <div class="col-md-8 col-lg-4">
                                    <div class="card login_card">
                                        <div class="login-brand" style="margin-bottom: 8px;">
                                            <img src="<?= base_url() . LOGO_IMG_PATH ; ?>hd_logo.png" alt="logo" width="300">
                                        </div>
                                        <div class="login-welcome-text">
                                            <h3>Sign In (Questioner)</h3>
                                            <p>Welcome! Let's get started. Sign in to explore</p>
                                        </div>
                                        <div class="card-body" style="margin-top: -22px;">
                                            <form method="POST" action="<?= base_url() ?>loginQuestioner" class="needs-validation" novalidate="">
                                            ...
                                            <div class="text-center mt-4 pb-3" style="font-weight: bold;font-size: 17px;">
                                            <?php
                                                ...
                                                <?php }else{?>
                                                    <div class="text-muted"><b></b>Want to Join as Questioner <a href="<?= base_url() ; ?>questioner-register">Register Here</a></b></div>
                                                <?php }
                                            ?>
                                            </div>
                                        </div>
