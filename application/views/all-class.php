                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='category_list' 
                                                   data-toggle="table" data-url="<?= base_url() . 'Table/all_class' ?>"
                                                ...
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="name" data-sortable="true">Class Name</th>
                                                        <th class="table-color" scope="col" data-field="category" data-sortable="false">Category</th>
                                                        <th class="table-color" scope="col" data-field="sub_category" data-sortable="false">Sub Category</th>
                                                        <th class="table-color" scope="col" data-field="status" data-sortable="false">Status</th>
                                                        <th class="table-color" scope="col" data-field="action" data-sortable="true">Action</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
