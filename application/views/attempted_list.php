                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3>Attempted List By Sub Category</h3>
                                        </div>
                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='category_list' 
                                                ...
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="user" data-sortable="true">User</th>
                                                        <th class="table-color" scope="col" data-field="email" data-sortable="true">Email</th>
                                                        <th class="table-color" scope="col" data-field="date" data-sortable="false">Date</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
