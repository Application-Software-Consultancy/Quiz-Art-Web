                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='category_list' 
                                                ...
                                                <thead class="table-head">
                                                    <tr>
                                                        ...
                                                        <th class="table-color" scope="col" data-field="status" data-sortable="true">Subject Name</th>
                                                        <th class="table-color" scope="col" data-field="image" data-sortable="false">Status</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
