...
$route['payment-gateway'] = 'Settings/payment_gateway';
...
/////////////////////// My Routes /////////////////////////////////
$route['student-category'] = 'Student/category';
$route['student-subcategory'] = 'Student/subcategory';
$route['student-category-delete'] = 'Student/category_delete';
$route['student-subcategory-delete'] = 'Student/subcategory_delete';
$route['questioner'] = 'Questioner';
$route['subject-category'] = 'Subject/category';
$route['subject-sub-category'] = 'Subject/subcategory';
$route['subject'] = 'Subject';
$route['chapters'] = 'Chapters';
$route['questioner-list'] = 'Questioner/list';
$route['get-subcategory'] = 'Allclass/get_subcategory';
$route['get-class'] = 'Allclass/get_class';
$route['get-subject'] = 'Allclass/get_subject';
$route['get-chapter'] = 'Allclass/get_chapter';
$route['get-all-questions'] = 'Questioner/get_all_questions';
$route['get-approved-questions'] = 'Questioner/get_approved_questions';
$route['videos'] = 'Questioner/videos';
$route['study_metarial'] = 'Questioner/study_metarial';
$route['smtp_settings'] = 'Settings/smtp_settings';
$route['admin_revenue'] = 'Settings/admin_revenue';
$route['enroll_list'] = 'Settings/enroll_list';
$route['attempted_list'] = 'Settings/attempted_list';
$route['total_question'] = 'Settings/total_question';
$route['new_report'] = 'Settings/new_report';
$route['contributor_report'] = 'Settings/contributor_report';
$route['coupon'] = 'Settings/coupon';

////////////////////////// Questioner Panel //////////////////////
$route['questioner-login'] = 'Questioner_login';
$route['questioner-register'] = 'Questioner_login/register';
$route['loginQuestioner'] = 'Questioner_login/loginQuestioner';
$route['registerQuestioner'] = 'Questioner_login/registerQuestioner';
$route['Questioner_dashboard'] = 'Questioner_dashboard';
$route['questioner_logout'] = 'Questioner_login/logout';

$route['questioner-add'] = 'Questioner_login/add';
$route['questioner-reset-password'] = 'Questioner_login/resetpassword';
$route['checkQOldPass'] = 'Questioner_login/checkOldPass';
$route['questioner-profile'] = 'Questioner_login/user_profile';
$route['create-question'] = 'Questioner_dashboard/create_question';
$route['list-question'] = 'Questioner_dashboard/question_list';
$route['create-questioner-questions/(:num)'] = 'Questioner_dashboard/edit_questioner_questions/$1';
